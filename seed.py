...
INITIAL_LOCATIONS = [
    {
        ...
        "buff": EnumBuff.rest,
        "event_type": EnumTypeEvent.positive_event,
        "location_type": EnumTypeLocation.common,
        "minigame": None,
    },
    {
        ...
        "buff": EnumBuff.danger,
        "event_type": EnumTypeEvent.negative_event,
        "location_type": EnumTypeLocation.uncommon,
